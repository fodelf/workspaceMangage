 ...
 * @LastEditors: 吴文周
 * @LastEditTime: 2020-03-29 20:16:08
 */
...
var createComponentTableSql =
  'create table if not exists component(componentId INTEGER PRIMARY KEY AUTOINCREMENT, componentName TEXT, gitUlr TEXT, dec TEXT,decImg TEXT,type TEXT,creatTime BLOB,deleteFlag INTEGER,userId TEXT);'
// 工具表
