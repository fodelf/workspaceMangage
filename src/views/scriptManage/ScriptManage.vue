 ...
 * @LastEditors: pym
 * @LastEditTime: 2020-04-12 22:06:46
 -->
<template>
  <div class="scriptManage">
    ...
    <div class="tableCon">
      <el-row :gutter='20'>
        <el-col :span="12"
                class='current_col'
                v-for="(item, index) in scriptCardList"
                :key="index">
          <!-- <div v-for="(item, index) in scriptCardList"
               :key="index"> -->
          <scriptCard :itemObj="item"></scriptCard>
          <!-- </div> -->
        </el-col>
      </el-row>
    </div>
    ...
    <AddScript @getList="getList"
               ref="proDialog"></AddScript>
  </div>
</template>

<script>
import scriptManage from './scriptManage.js'
export default {
  ...scriptManage
}
</script>
